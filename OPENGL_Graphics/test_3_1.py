...
# move a triangle around the screnn
class Test(Base):
    ...
    def initialize(self):
        ...
        varRef=glGenVertexArrays(1)
        glBindVertexArray(varRef)
        ...
        ### set up uniforms ###
        mMatrix=Matrix.makeTranslation(0.0,0.0,-1.0)
        ...
        self.projectoinMatrix=Uniform("mat4",pMatrix)
        self.projectoinMatrix.locateVariable(self.programRef,"projectionMatrix")
        
        ### movement speed, units per second 
        self.moveSpeed=0.5
        ### rotation speed, radians per second
        self.turnSpeed=90*(pi/180.0)
    ...
    def update(self):
        ...
        # local rotaion (around object center)
        ...
        self.projectoinMatrix.uploadData()
